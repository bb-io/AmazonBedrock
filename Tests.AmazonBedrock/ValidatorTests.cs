using Apps.AmazonBedrock.Connections;
...
public class ValidatorTests : TestBase
{
    ...
    public async Task ValidateConnection_InvalidConnection_ShouldFail()
    {
        ...
        var newCredentials = Creds.Select(x => new AuthenticationCredentialsProvider(AuthenticationCredentialsRequestLocation.None, x.KeyName, x.Value + "_incorrect"));
